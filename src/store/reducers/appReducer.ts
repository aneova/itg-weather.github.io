...
const appSlice = createSlice({
  ...
  reducers: {
    ...
    setIsError: (state: IAppState, action: PayloadAction<boolean>) => {
      state.IsError  = action.payload;
    },
  },
});

export const { changeTempUnit, toggleDarkMode, setIsLoading, setIsInitial, setIsError } = appSlice.actions;
